...
public class XMPPEventAdapter implements OutputEventAdapter {
    ...
    try {
        ...
        if (log.isDebugEnabled()) {
            log.debug(" XMPP deployed successfully");
        }
    } catch (RuntimeException e) {
        log.error("Error deploying", e);
    }
    }
    ...
    class XMPPSender implements Runnable {
        ...
        public void connect() {
            try {
					...
					con.connect();
					System.out.println("here is a connection");
    ...
    public void publish(Object message, Map<String, String> dynamicProperties) {
        ...
        try {
            ...
            EventAdapterUtil.logAndDrop(eventAdapterConfiguration.getName(), message, "queue is full", e, log,
                                        tenantId);
        }
    }
    @Override
